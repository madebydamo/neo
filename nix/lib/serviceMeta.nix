      ...
      mkServiceMeta = {
        ...
        with lib; {
          meta = mkOption {
            type = types.submodule {
              options = {
                ...
                description = mkOption {
                  type = types.str;
                  default = description;
                  description = "Longer human-friendly introduction shown above the settings form.";
                };
                projectUrl = mkOption {
                  type = types.nullOr types.str;
                  default = projectUrl;
                  description = "Link to the project's homepage.";
                };
                githubUrl = mkOption {
                  type = types.nullOr types.str;
                  default = githubUrl;
                ...
                releaseUrl = mkOption {
                  type = types.nullOr types.str;
                  default = releaseUrl;
                  description = "Link to releases / changelog.";
                };
                screenshots = mkOption {
                  type = types.listOf (types.submodule {
                    options = {
                      url = mkOption {
                        type = types.str;
                        description = "Public image URL for an example screenshot.";
                      };
                      caption = mkOption {
                        type = types.nullOr types.str;
                        default = null;
            ...
            default = args;
            internal = true;
            description = "Rich metadata used by the neo web UI to render an introductory header for the service.";
          };
        };
    };
  };

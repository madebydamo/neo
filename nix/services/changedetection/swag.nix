# Changedetection reverse proxy configuration for SWAG.
# Protects the web UI with tinyauth forward authentication.
{...}: {
  ...
  in {
    config.neo.services.changedetection.proxyConf = lib.mkDefault ''
      server {
